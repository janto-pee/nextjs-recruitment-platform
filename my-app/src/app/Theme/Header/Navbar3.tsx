          ...
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center justify-between">
              <div className="flex flex-1 items-center lg:hidden">
                ...
                <a
                  href="#"
                  className="ml-2 p-2 text-gray-200 hover:text-gray-500"
                >
                ...
                <div className="flex h-full space-x-8">
                                          ...
                                          >
                                            ...
                                            <div className="flex flex-col justify-end">
                                              <div className="bg-white bg-opacity-60 p-4 text-sm">
                                                ...
                                                <p
                                                  aria-hidden="true"
                                                  className="mt-0.5 text-gray-100 sm:mt-1"
                                                >
                                                  Shop now
                                                </p>
                                              </div>
                  ...
                  {navigation.pages.map((page) => (
                    <a
                      key={page.name}
                      href={page.href}
                      className="flex items-center text-sm font-medium text-gray-100 hover:text-gray-800"
                    >
                      {page.name}
                    </a>
                  ))}
              ...
              <a href="#" className="flex">
                ...
                <img className="h-8 w-auto" src="/tailwind.svg" alt="" />
              </a>

              <div className="flex flex-1 items-center justify-end">
                <a
                  href="#"
                  className="hidden text-gray-100 hover:text-gray-800 lg:flex lg:items-center"
                >
                  <img
